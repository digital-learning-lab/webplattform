...
class SuccessfulPasswordResetTests(TestCase):
    def setUp(self):
        email = 'john@doe.com'
        USER_MODEL.objects.create_user(username='john', email=email, password='123abcdef')
        url = reverse('user:password_reset')
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        user = USER_MODEL.objects.create_user(username='john', email='john@doe.com', password='123abcdef')
        ...
        url = reverse('user:password_reset_confirm', kwargs={'uidb64': self.uid, 'token': self.token})
...
class InvalidPasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('user:password_reset_confirm', kwargs={'uidb64': uid, 'token': token})
        self.response = self.client.get(url)
