<template>
  <app-content-submission-form :errors="errors" :mode="mode" :loading="loading" :saved="saved" @update="updateContent" @create="createContent" @preview="goToPreview" @delete-warning="showDeleteWarning" :data="data" @delete="deleteContent" @submit="submitContent" @update-review="updateReview" @approve-review="approveContent" @decline-review="declineContent">
    ...
    <div v-if="mode === 'edit' || mode === 'review'">
      ...
      <app-list-input id="goals" :readonly="readonly" :review="review" label="Ziele" :list.sync="data.learning_goals" :review-value.sync="reviewValue.learning_goals" :error="errorFields.includes('learning_goals')" :initial="data.learning_goals" :help-text="getHelpText('learning_goals')"></app-list-input>
      ...
      <app-list-input id="subject-of-tuition" :readonly="readonly" :review="review" label="Informationen zum Unterrichtsgegenstand" :list.sync="data.subject_of_tuition" :review-value.sync="reviewValue.subject_of_tuition" :error="errorFields.includes('subject_of_tuition')" :initial="data.subject_of_tuition" :help-text="getHelpText('subject_of_tuition')"></app-list-input>
      <app-list-input id="expertise" :readonly="readonly" :review="review" label="Fachkompetenzen" :list.sync="data.expertise" :review-value.sync="reviewValue.expertise" :error="errorFields.includes('expertise')" :initial="data.expertise" :help-text="getHelpText('expertise')"></app-list-input>
      <app-list-input id="equipment" :readonly="readonly" :review="review" label="Medienausstattung" :list.sync="data.equipment" :review-value.sync="reviewValue.equipment" :error="errorFields.includes('equipment')" :initial="data.equipment" :help-text="getHelpText('equipment')"></app-list-input>
