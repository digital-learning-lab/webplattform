<template>
  <app-content-submission-form :errors="errors" :mode="mode" :loading="loading" :saved="saved" @update="updateContent" @create="createContent" @preview="goToPreview" @delete-warning="showDeleteWarning" :data="data" @delete="deleteContent" @submit="submitContent" @update-review="updateReview" @approve-review="approveContent" @decline-review="declineContent" :can-delete="canDelete">
    ...
    <div v-if="mode === 'edit' || mode === 'review'">
      ...
      <app-data-protection-input id="provider" label="Anbieter" :readonly="readonly" :review="review" :complianceText.sync="data.data_privacy_assessment.provider_text" :compliance.sync="data.data_privacy_assessment.provider" :review-value.sync="reviewValue.provider" :error="errorFields.includes('provider')" :help-text="getHelpText('provider')" icon="anbieter"></app-data-protection-input>
      ...
      <app-data-protection-input id="data_privacy_terms" label="Datenschutzerklärung" :readonly="readonly" :review="review" :complianceText.sync="data.data_privacy_assessment.data_privacy_terms_text" :compliance.sync="data.data_privacy_assessment.data_privacy_terms" :review-value.sync="reviewValue.data_privacy_terms" :error="errorFields.includes('data_privacy_terms')" :help-text="getHelpText('data_privacy_terms')" icon="datenschutzerklarung"></app-data-protection-input>
      <app-data-protection-input id="terms_and_conditions" label="AGB" :readonly="readonly" :review="review" :complianceText.sync="data.data_privacy_assessment.terms_and_conditions_text" :compliance.sync="data.data_privacy_assessment.terms_and_conditions" :review-value.sync="reviewValue.terms_and_conditions" :error="errorFields.includes('terms_and_conditions')" :help-text="getHelpText('terms_and_conditions')" icon="agb"></app-data-protection-input>
      <app-data-protection-input id="security" label="Sicherheit" :readonly="readonly" :review="review" :complianceText.sync="data.data_privacy_assessment.security_text" :compliance.sync="data.data_privacy_assessment.security" :review-value.sync="reviewValue.security" :error="errorFields.includes('security')" :help-text="getHelpText('security')" icon="sicherheit"></app-data-protection-input>
      <app-text-area id="conclusion" :readonly="readonly" :review="review" label="Fazit" :required="false" :value.sync="data.data_privacy_assessment.conclusion" :review-value.sync="reviewValue.conclusion" :error="errorFields.includes('conclusion')" :rows="3" :help-text="getHelpText('conclusion')" :character-counter="true" :maximal-chars="700"></app-text-area>
    </div>
