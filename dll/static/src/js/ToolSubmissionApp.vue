<template>
  <app-content-submission-form :errors="errors" :mode="mode" :loading="loading" :saved="saved" @update="updateContent" @create="createContent" @preview="goToPreview" @delete-warning="showDeleteWarning" :data="data" @delete="deleteContent" @submit="submitContent" @update-review="updateReview" @approve-review="approveContent" @decline-review="declineContent" :can-delete="canDelete">
    ...
    <div v-if="mode === 'edit' || mode === 'review'">
      ...
      <app-data-protection-input id="server_location" :readonly="readonly" :review="review" :links.sync="data.server_location" :review-value.sync="reviewValue.server_location" :error="errorFields.includes('server_location')" :help-text="getHelpText('server_location')" :icon="''"></app-data-protection-input>
      <app-data-protection-input id="provider" :readonly="readonly" :review="review" :links.sync="data.provider" :review-value.sync="reviewValue.provider" :error="errorFields.includes('provider')" :help-text="getHelpText('provider')" :icon="''"></app-data-protection-input>
      <app-data-protection-input id="user_registration" :readonly="readonly" :review="review" :links.sync="data.user_registration" :review-value.sync="reviewValue.user_registration" :error="errorFields.includes('user_registration')" :help-text="getHelpText('user_registration')" :icon="''"></app-data-protection-input>
      <app-data-protection-input id="data_privacy_terms" :readonly="readonly" :review="review" :links.sync="data.data_privacy_terms" :review-value.sync="reviewValue.data_privacy_terms" :error="errorFields.includes('data_privacy_terms')" :help-text="getHelpText('data_privacy_terms')" :icon="''"></app-data-protection-input>
      <app-data-protection-input id="terms_and_conditions" :readonly="readonly" :review="review" :links.sync="data.terms_and_conditions" :review-value.sync="reviewValue.terms_and_conditions" :error="errorFields.includes('terms_and_conditions')" :help-text="getHelpText('terms_and_conditions')" :icon="''"></app-data-protection-input>
      <app-data-protection-input id="security" :readonly="readonly" :review="review" :links.sync="data.security" :review-value.sync="reviewValue.security" :error="errorFields.includes('security')" :help-text="getHelpText('security')" :icon="''"></app-data-protection-input>
    </div>
