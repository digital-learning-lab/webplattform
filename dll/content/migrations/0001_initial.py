    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learning_goals', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Lernziele')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_of_tuition', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Unterichtsgegenstand')),
                ...
                ('estimated_time', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Zeitumfang')),
                ('equipment', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Ausstattung')),
                ...
                ('expertise', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Fachkompetenzen')),
            ...
            options={
                'permissions': (('review_teachingmodule', 'Can review Teaching Module'),),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pro', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Pro')),
                ('contra', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Kontra')),
            ...
            options={
                'permissions': (('review_tool', 'Can review Tool'),),
            },
            bases=('content.content',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_group', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Zielgruppe')),
                ('publisher', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), default=list, size=None, verbose_name='Herausgeber')),
            ...
            options={
                'permissions': (('review_trend', 'Can review Trend'),),
            },
            bases=('content.content',),
        ),
        migrations.CreateModel(
