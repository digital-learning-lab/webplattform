    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checked_text', models.CharField(blank=True, max_length=300, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cc', django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(max_length=254), null=True, size=None)),
                ('bcc', django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(max_length=254), null=True, size=None)),
                ...
                ('sender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='communication_events', to=settings.AUTH_USER_MODEL, verbose_name='Auslösender User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(max_length=500, null=True, verbose_name='Nachricht')),
                ('by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_invitations', to=settings.AUTH_USER_MODEL, verbose_name='Einladung von')),
            ],
            options={
                'ordering': ('-modified', '-created'),
                'get_latest_by': 'modified',
